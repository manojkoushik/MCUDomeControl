...
; Generated by Manoj Koushik on 6/3/2017 (UTC)
;
[Setup]
AppID={{806bf2fd-65de-4d5f-86c0-38b7afcb27d6}
AppName=ASCOM Photon Dome Driver
AppVerName=ASCOM Photon Dome Driver 1.0.0
AppVersion=1.0.0
...
OutputDir="."
OutputBaseFilename="Photon DC Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\Photon DC"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\Photon DC"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
; regserver flag only if native COM, not .NET
Source: "C:\Users\manoj\OneDrive\Documents\Visual Studio 2015\Projects\ArduinoDome\ArduinoDome\bin\Release\ASCOM.Arduino.Dome.dll"; DestDir: "{app}" ;AfterInstall: RegASCOM(); Flags: regserver
...
begin
   ...
   P.DeviceType := 'Dome';
   P.Register('Photon DC.Dome', 'Photon Dome Control');
end;
